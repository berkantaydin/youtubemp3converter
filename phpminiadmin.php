...
*/
 ...
 $ACCESS_PWD='berkantx'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"ann",#required
 'pwd'=>"HypAIruV", #required
 'db'=>"bari",  #optional, default DB
 'host'=>"tunnel.pagodabox.com",#optional
 'port'=>"3306",#optional
